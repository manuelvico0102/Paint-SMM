...
/**
 * Esta clase define objetos de Mirectangulo a la cual se le agrega un método
 * para facilitar mover los objetos.
 * 
 * @author Manuel Vico
 */
public class MiRectangulo extends Rectangle implements MiShape{
    ...
    public MiRectangulo(int x, int y, int width, int height){
        super(x, y, width, height);
        this.p1 = new Point2D.Double(x, y);
    }
    
    /**
     * Método para posicionar el objeto MiRectangulo en la nueva posicion dada.
