...
/**
 * Esta clase define objetos de Area a la cual se le agrega un método
 * para facilitar mover los objetos.
 * 
 * @author Manuel Vico
 */
public class MiArea extends Area implements MiShape{
    /**
     ...
     * 
     * @param s el Shape area 
     */
    public MiArea(Shape s){
        super(s);
        Rectangle2D rect = this.getBounds2D();
        this.p1 = new Point2D.Double(rect.getX(), rect.getY());
    }
    
    /**
     * Método para posicionar el objeto Area en la nueva posicion dada.
     * Calcula la distancia del punto dado y la del rectágulo que contiene 
     * al área para posicionar el objeto
     * 
     * @param pos Punto de coordenadas donde posicionar el objeto
     */
    public void setLocation(Point2D pos) {       
        Rectangle2D rect = this.getBounds2D();
        double dx = pos.getX() - rect.getX();
        double dy = pos.getY() - rect.getY();
